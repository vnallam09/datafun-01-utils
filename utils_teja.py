...
# ----------------------------------
author: str = "Venkat Teja Nallamothu"
organization: str = "N V Tech Solutions"
motto: str = "Turning Data into Insights"

location: str = "Piscataway, NJ"
...
office_locations: list[str] = ["New York", "Los Angeles", "Chicago", "Houston", "Miami"]
